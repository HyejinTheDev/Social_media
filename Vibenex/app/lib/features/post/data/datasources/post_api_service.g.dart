...
class _PostApiService implements PostApiService {
  ...
  @override
  Future<PaginatedPostsResponse> getFeed(int page, int limit) async {
    ...
    late PaginatedPostsResponse _value;
    try {
      _value = PaginatedPostsResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<dynamic> getLikeStatus(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<PaginatedCommentsResponse> getComments(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<PaginatedCommentsResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late PaginatedCommentsResponse _value;
    try {
      _value = PaginatedCommentsResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
