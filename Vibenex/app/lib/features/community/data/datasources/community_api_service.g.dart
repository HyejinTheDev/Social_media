...
class _CommunityApiService implements CommunityApiService {
  ...
  Future<PaginatedCommunitiesResponse> getCommunities(
    ...
    final _options = _setStreamType<PaginatedCommunitiesResponse>(
    ...
    late PaginatedCommunitiesResponse _value;
    try {
      _value = PaginatedCommunitiesResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<CommunityModel> createCommunity(Map<String, dynamic> body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
