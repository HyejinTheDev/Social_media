...
part of 'friend_api_service.dart';
...
class _FriendApiService implements FriendApiService {
  _FriendApiService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<dynamic> sendRequest(String receiverId) async {
  ...
  @override
  Future<dynamic> removeFriend(String friendId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
