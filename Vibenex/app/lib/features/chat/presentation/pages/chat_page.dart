              ...
              child: Column(
                ...
                children: [
                  ...
                  if (_isOtherTyping)
                    const Text(
                      'Đang nhập...',
                      style: TextStyle(fontSize: 12, color: AppColors.brandViolet, fontStyle: FontStyle.italic),
                    ),
                ],
              ),
            ),
                ...
                if (state.messages.isEmpty) {
                  return const Center(
                    child: Column(
                      ...
                      children: [
                        Icon(Icons.waving_hand, size: 48, color: AppColors.brandViolet),
                        SizedBox(height: 12),
                        Text('Hãy bắt đầu cuộc trò chuyện!', style: TextStyle(color: AppColors.textFog)),
                      ],
                    ),
                  );
                }
                ...
                Expanded(
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      filled: true,
                      fillColor: AppColors.surfaceMidnight,
          ...
          Flexible(
            child: Container(
              ...
              decoration: BoxDecoration(
                color: isMe ? null : AppColors.surfaceMidnight,
              ...
              child: Column(
                ...
                children: [
                  Text(
                    content,
                    style: TextStyle(
                      color: isMe ? Colors.white : AppColors.textSilver,
                      fontSize: 15,
                      height: 1.3,
                    ),
                  ),
                    ...
                    children: [
                      if (createdAt != null)
                        Text(
                          ...
                          style: TextStyle(
                            color: isMe ? Colors.white.withValues(alpha: 0.7) : AppColors.textFog,
                            fontSize: 10,
                          ),
                        ),
